      ...
      <div className="mx-auto max-w-2xl">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-8">
            <div className="w-12 h-12 rounded-xl bg-[#0E6B6B] text-white flex items-center justify-center">
              <BookPlus size={24} />
            </div>
            <div>
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-300 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#95C8CB] focus:border-transparent transition"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-300 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#95C8CB] focus:border-transparent transition resize-none"
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  value={form.level}
                  onChange={handleChange}
                  className="w-full px-4 py-3 rounded-xl border border-gray-300 text-sm text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-[#95C8CB] focus:border-transparent transition"
                >
                  {LEVELS.map((level) => (
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl bg-[#0E6B6B] text-white text-sm font-semibold hover:bg-[#5FA3A3] focus:outline-none focus:ring-2 focus:ring-[#95C8CB] focus:ring-offset-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
